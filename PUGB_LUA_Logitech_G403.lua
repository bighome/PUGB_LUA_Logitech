...
---- 绑定将模式 ----
----默认 AKM 为鼠标返回键  M416为前进件 关闭为鼠标中键
...
---- 暂停键 ----
---- 可使用 "lalt", "ralt", "alt"  "lshift", "rshift", "shift"  "lctrl", "rctrl", "ctrl"

local ignore_key = "lctrl"
